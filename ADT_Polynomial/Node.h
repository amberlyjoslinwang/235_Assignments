...
Description:	Header file of Node class. This is merely
...
/** @file Node.h 
	Listing 4-1 */
#ifndef TEACH_CSCI235_LinkedPolynomial_NODE_H_
#define TEACH_CSCI235_LinkedPolynomial_NODE_H_
...
public:
   ...
   // Constucts a node holding an_item nand pointing to NULL.
...
private:
   ItemType exponent_;
   ItemType coefficient_;
   
   Node<ItemType>* next_node_; // Pointer to next node
}; // end Node

#include "Node.cpp"
#endif  // TEACH_CSCI235_LinkedPolynomial_NODE_H_
